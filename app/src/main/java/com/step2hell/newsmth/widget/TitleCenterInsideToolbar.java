...
/**
 * Created by bob on 9/27/17.
 */

public class TitleCenterInsideToolbar extends Toolbar {
    private TextView mTitleTextView;
    private CharSequence mTitleText;
    private int mTitleTextColor;
    private int mTitleTextAppearance;

    public TitleCenterInsideToolbar(Context context) {
        super(context);
        resolveAttribute(context, null, R.attr.toolbarStyle);
    }

    public TitleCenterInsideToolbar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        resolveAttribute(context, attrs, R.attr.toolbarStyle);
    }

    public TitleCenterInsideToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
